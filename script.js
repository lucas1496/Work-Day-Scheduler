...
// Calculates the start of day at 9am
...
// Function to compare hour containers with current time 
function testTime() {
    // Add time1 9am
    time1 = moment().startOf('day').add(9, "hours");
    // Adjusts current time to the hour
    currentTime = currentTime.startOf("hour");
    // Add time1 if/else if
...
// Event listener to save data to local stroage
